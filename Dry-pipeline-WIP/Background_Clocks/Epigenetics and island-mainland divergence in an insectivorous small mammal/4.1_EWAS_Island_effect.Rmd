...
https://rpubs.com/mlcossette9224/946399
...
#### 2. Boxplots DNAm level vs location for top 10 significant
...
#### 3. Boxplots DNAm level vs sex for top 10 significant

```{r plotting boxplots for sex, echo=TRUE, warning=FALSE, message=FALSE}
#need to update and put CpGs of interest (top 10) in the same column using gather (change wide format to tall)
