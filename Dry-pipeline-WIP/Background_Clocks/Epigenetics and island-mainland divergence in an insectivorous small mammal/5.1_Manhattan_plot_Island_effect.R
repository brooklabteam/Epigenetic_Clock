##R Script for EWAS Manhattan plot (Island vs mainland)
...
tab <- read_csv("EWAS/EbFit_Island_effect.csv")
...
#save to computer
write.csv(allData_manhattan,file="allData_manhattan_sorexcinereus_Island.csv")
...
manhplot <- ggplot(allData_manhattan, aes(x = bp_cum, y = -log10(p))) +
  ...
  scale_y_continuous(expand = c(0,0), limits = c(0, ylim), breaks = seq(4, 20, by = 4)) +
